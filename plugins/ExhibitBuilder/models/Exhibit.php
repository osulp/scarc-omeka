...
class Exhibit extends Omeka_Record_AbstractRecord implements Zend_Acl_Resource_Interface
{
    ...
    {
//		return $this->getTable('ExhibitPage')->findBy(array('exhibit'=>$this->id, 'topOnly'=>true, 'sort_field'=>'order'))->findEndChild($this, 'first');
		return $this->getTable('ExhibitPage')->findNext($this);
