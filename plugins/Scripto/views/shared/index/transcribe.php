...
<?php endif; ?>
<!--Click on [edit] below to begin your transcription:-->
...
<li>Ignore formatting (e.g. spacing, line breaks, alignment)</li>
<li>If you can't make out a word, enter "[illegible]"; if uncertain, indicate with square brackets, e.g. "[town?]"</li>
<li>Transcribe letterhead information when possible.</li>
<li>Click on Save below the box to save.</li>
</ul>
...
<div id="scripto-transcription">
    ...
    <div id="scripto-transcription-edit" style="display: none;">
        ...
        <div>
            <?php echo $this->formButton('scripto-transcription-page-edit', __('Save'), array('style' => 'display:inline; float:none;')); ?> 
        </div>
